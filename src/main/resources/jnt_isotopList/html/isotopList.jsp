...
<ul class="nav nav-pills" id="isotope-filter-${currentNode.identifier}">
...
<div id="isotope-${currentNode.identifier}" class="thumbnails">
    <c:forEach items="${moduleMap.currentList}" var="isotopEntry" begin="${moduleMap.begin}" end="${moduleMap.end}">
        <template:module node="${isotopEntry}" nodeTypes="jnt:isotopEntry"/>
    </c:forEach>
</div>
<c:if test="${renderContext.editMode}">
    <template:module path="*" nodeTypes="jnt:isotopEntry"/>
</c:if>
<c:if test="${! renderContext.editMode}">
    <template:addResources type="inline">
        ...
        <script type="text/javascript">
            jQuery(window).load(function () {
                ...
                $('#isotope-filter-${currentNode.identifier} a').click(function () {
                    $('#isotope-filter-${currentNode.identifier} li').removeClass('active');
